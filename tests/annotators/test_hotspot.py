...
def test_hotspot_annotator_no_overlap_2(test_scheme, setup_annotator, get_test_file,
                                        get_empty_maf_record):
    """
    Not a hotspot 
    """
    ...
    maf_record['HGVSp_Short'] = get_builder('HGVSp_Short', test_scheme, value='p.R547fs')
