...
def get_test_scheme():
    ...
    """
    def generate_scheme(coldict, name="_TestScheme", version="test-version", 
...
def get_test_vcf_record():
    ...
    """
    def generate_vcf_record(chrom=None, pos=None, stop=None, alleles=(), 
        ref=None, alts=(), samples={}, info={}
    ):
