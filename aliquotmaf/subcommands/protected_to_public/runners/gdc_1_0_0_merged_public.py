"""
Main logic for filtering merged protected MAF to public for spec
gdc-1.0.0-merged-public.
"""
import json
...
class GDC_1_0_0_Merged_Public(BaseRunner):
    def __init__(self, options=dict()):
        super(GDC_1_0_0_Merged_Public, self).__init__(options)

        # Schema
        self.options['version'] = 'gdc-1.0.0'
        self.options['annotation'] = 'gdc-1.0.0-merged-public'
    ...
    def __tool_name__(cls):
        return "gdc-1.0.0-merged-public"
